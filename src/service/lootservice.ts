...
export class LootService {
        ...
        return [
            {
                ...
                boss: {
                    id: 0,
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Tank')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Life')?.name
                },
                belongTo: 'Kricktria',
                belongToId: 0
            },
            {
                ...
                boss: {
                    id: 0,
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Healer')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Retribution')?.name
                },
                belongTo: 'Kricktria',
                belongToId: 0
            },
            {
                ...
                boss: {
                    id: 0,
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Mage')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Retribution')?.name
                },
                belongTo: 'Kricktria',
                belongToId: 0
            ...
            },
            {
                ...
                boss: {
                    ...
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Mage')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Balance')?.name
                },
                belongTo: 'Kricktria',
                belongToId: 0
            },
            {
                ...
                boss: {
                    id: 0,
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Ranger')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Retribution')?.name
                },
                belongTo: 'Kricktria',
                belongToId: 0
            },
            {
                ...
                boss: {
                    id: 0,
                    name: '',
                    class: this.getAllBossType().find((x) => x.name == 'Assault')?.name,
                    element: this.getAllBossElement().find((x) => x.name == 'Balance')?.name
                },
                belongTo: 'Mouspia',
                belongToId: 1
    ...
    getBossesElement() {
        return Promise.resolve(this.getAllBossElement());
    }
